...
public class GregorianDate {
    ...
    public GregorianDate(String month, int day, int year) throws AmeException{
		if (day > 31) { //exception is created

			throw new AmeException(8); // thrown to the next method that calls GregorianDate
		}
